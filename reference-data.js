...
handle = win32file.CreateFile(path, access, 0, None,
  ...
  pywin32Modules: [
    ...
    },
    {
      ...
      description: "Python's foreign-function interface. In this course it fills deliberate gaps in pywin32 while making ABI details—types, pointers, structures, calling convention, error state, and ownership—explicit.",
      ...
      features: [
        ...
        { name: "handle ownership", task: "Close native handles exactly once", detail: "A ctypes integer handle has no automatic pywin32 lifetime. Use the documented closer—CloseHandle, CloseServiceHandle, LocalFree, or another API—in finally." },
