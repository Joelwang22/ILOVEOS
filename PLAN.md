...
- A primary-source theoretical audit covers all 32 operator-assisted and two authorised-lab-only implementations. All 32 argument parsers, the documented 64-bit ctypes ABIs and constants, and seven non-mutating pending paths were probed successfully; no blocking runtime-contract contradiction was found. This raises normal-path confidence but does not replace external-tool, architecture, permission, sequencing, or cleanup evidence.
