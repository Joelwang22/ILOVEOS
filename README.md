...
- Purpose-first pywin32 guide covering the complete 1,419-callable documented/runtime union across 34 modules, with curated guidance retained for course-facing entries.
- Windows API guide with 135 hand-authored callable variants grouped into 106 teaching families, plus an exhaustive generated catalogue of all 18,301 P/Invoke functions in the pinned Microsoft Win32 metadata package (222 namespaces and 368 DLLs).
...
The native catalogue is generated by `node scripts/build-windows-sdk-catalog.mjs` from the SHA-256-pinned `Microsoft.Windows.SDK.Win32Metadata` package. Its regression test checks every generated function identity, signature, parameter list, namespace, DLL, and Microsoft Learn link, then exercises catalogue search, pagination, routing, and popup rendering in Chromium.
